...
#   powershell -ExecutionPolicy Bypass -File "D:\ai프로젝트\obsidian-agent-brain-system\scripts\setup_claude_settings.ps1"

$SETTINGS_PATH = "$env:USERPROFILE\.claude\settings.json"
$G_DRIVE = "D:/ai프로젝트/obsidian-agent-brain-system/scripts"
...
$SYNC_SCRIPT = "D:/ai프로젝트/obsidian-agent-brain-system/scripts/sync_claude_instructions.py"
...
if ($PYTHON_EXE) {
    $ACTION  = New-ScheduledTaskAction `
        -Execute $PYTHON_EXE `
        -Argument "`"D:/ai프로젝트/obsidian-agent-brain-system/scripts/sync_claude_instructions.py`""
