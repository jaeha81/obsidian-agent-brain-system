...
NAME_KEYWORD_PRICES: list[tuple[str, str, int]] = [
    ...
    ("바닥공사", "LOT", 8_500_000),
    ("철거 공사", "LOT", 6_500_000),
    # LOW 19개 보강 (2026-06-24)
    ("동선바닥보양", "M", 8_500),
    ("동선바닥 중량물양중", "M", 18_000),
    ("방수턱 거푸집 철거", "M", 18_000),
    ("담수테스트", "식", 280_000),
    ("주방출입구 슬로프", "개소", 1_200_000),
    ("텅스텐 재료분리대", "식", 1_500_000),  # 현설 누락 #1 연동
    ("아치형 조명구조", "개소", 4_500_000),  # 현설 누락 #7 연동 (아크 구조물)
    ("타일 코너보호대", "M", 28_000),
    ("SUS 코너마감재", "M", 28_000),
    ("타일 걸레받이 코너용", "PCS", 14_000),
    ("타일 걸레받이", "PCS", 12_000),
    ("걸레받이 타일 시공", "M", 18_000),
    ("타일 부자재", "M", 8_000),            # 줄눈재·본드·접착제 M 단위 (M2와 별도)
    ("지정 메지 공급 및 설치", "M", 12_000), # 메지 선형 M 단위
    ("주방 오픈게이트 후레임", "M", 52_000),
    ("출입문후레임", "M", 52_000),
    ("자동문 후레임", "M", 52_000),
    ("자동문 도어", "EA", 4_500_000),  # 현설 누락 #5 연동
    ("와이어 아트웍", "개소", 850_000),
]
