...
Files: `20` / Nodes: `160` / Edges: `1340`

## Top Nodes

- `index` (link) - weighted degree 149
...
- `concept-infranodus-graph-knowledge-base` (page) - weighted degree 65
- `log` (link) - weighted degree 65
...
- Graph HTML: `C:\Users\user1\Documents\Obsidian Vault\infranodus\graph-snapshots\2026-05-12-022632-wiki-local-graph.html`
- Ontology JSON: `C:\Users\user1\Documents\Obsidian Vault\infranodus\ontology\2026-05-12-022632-wiki-local-graph.json`